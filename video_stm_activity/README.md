...
python -m src.run_experiment --models minicpm_o_26 --modes stm none --video phone1.mp4 --debug
python -m src.run_experiment --models internvl2_2b --modes stm none --video phone1.mp4 --debug
# Export scoring metrics
python -m src.run_experiment --modes stm none --export_caption_eval --eval_videos 10 --eval_frames 5
